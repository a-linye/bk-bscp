...
func newConfig(db *gorm.DB, opts ...gen.DOOption) config {
	...
	_config.configDo.UseModel(&table.Config{})
...
func (c configDo) Create(values ...*table.Config) error {
	if len(values) == 0 {
		return nil
	}
...
func (c configDo) CreateInBatches(values []*table.Config, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c configDo) Save(values ...*table.Config) error {
	if len(values) == 0 {
		return nil
	}
...
func (c configDo) First() (*table.Config, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*table.Config), nil
	}
}

func (c configDo) Take() (*table.Config, error) {
...
func (c configDo) Last() (*table.Config, error) {
...
func (c configDo) Find() ([]*table.Config, error) {
	result, err := c.DO.Find()
	return result.([]*table.Config), err
}

func (c configDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*table.Config, err error) {
	buf := make([]*table.Config, 0, batchSize)
...
func (c configDo) FindInBatches(result *[]*table.Config, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c configDo) FirstOrInit() (*table.Config, error) {
...
func (c configDo) FirstOrCreate() (*table.Config, error) {
...
func (c configDo) FindByPage(offset int, limit int) (result []*table.Config, count int64, err error) {
...
func (c configDo) Delete(models ...*table.Config) (result gen.ResultInfo, err error) {
