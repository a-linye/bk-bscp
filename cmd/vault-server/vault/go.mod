...
// Clone from: git clone -b f-v2.5.3-add-mysql-backend https://github.com/silenceper/openbao.git /data/go/src/github.com/openbao/openbao
// OpenBao root code depends on api/sdk/auth package content from the same fork commit.
replace (
	github.com/openbao/openbao => github.com/silenceper/openbao v0.0.0-20260513110329-92aa53862362
	github.com/openbao/openbao/api/auth/approle/v2 => github.com/silenceper/openbao/api/auth/approle/v2 v2.4.1-0.20260513110329-92aa53862362
	github.com/openbao/openbao/api/auth/kubernetes/v2 => github.com/silenceper/openbao/api/auth/kubernetes/v2 v2.4.1-0.20260513110329-92aa53862362
	github.com/openbao/openbao/api/auth/userpass/v2 => github.com/silenceper/openbao/api/auth/userpass/v2 v2.4.1-0.20260513110329-92aa53862362
	github.com/openbao/openbao/api/v2 => github.com/silenceper/openbao/api/v2 v2.0.0-20260513110329-92aa53862362
...
require (
	...
	github.com/michaelklishin/rabbit-hole/v3 v3.5.0 // indirect
	...
	github.com/openbao/openbao-template v1.0.1 // indirect
