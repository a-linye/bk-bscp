...
func mig20250923114027Up(tx *gorm.DB) error {
	...
	type ProcessInstances struct {
		...
		HostInstSeq     uint      `gorm:"column:host_inst_seq;type:bigint;not null;comment:主机下唯一标识" json:"host_inst_seq"`                                                           // host_inst_seq 主机级别的序号
		ModuleInstSeq   uint      `gorm:"column:module_inst_seq;type:bigint;not null;comment:模块下唯一标识" json:"module_inst_seq"`                                                       // module_inst_seq 模块级别的序号
