...
func mig20250923114027Up(tx *gorm.DB) error {
	...
	type ProcessInstances struct {
		...
		LocalInstID     uint      `gorm:"column:local_inst_id;type:bigint;not null;comment:LocalInstID" json:"local_inst_id"`                                                       // LocalInstID
		InstID          uint      `gorm:"column:inst_id;type:bigint;not null;comment:InstID" json:"inst_id"`                                                                        // InstID
