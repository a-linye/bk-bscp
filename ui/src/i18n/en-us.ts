export default {
  ...
  表达式: 'Expression',
  筛选: 'Filter',
  '支持 gsekit 表达式语法': 'Supports gsekit expression syntax',
  '通配符：proc* / proc?': 'Wildcard: proc* / proc?',
  '枚举：[a, b]': 'Enumeration: [a, b]',
  '数字范围：[1-100]': 'Numeric range: [1-100]',
  '字母范围：[a-f]': 'Letter range: [a-f]',
  '排除：[!ab]': 'Exclusion: [!ab]',
  '前缀组合：4[6, 8, 9]': 'Prefix combination: 4[6, 8, 9]',
  '切片（仅 CC 进程ID）：[0:10]、[-5:]': 'Slice (CC process ID only): [0:10], [-5:]',
  '留空默认匹配任意（*）': 'Leave blank to match any (*)',
  正式: 'Official',
  体验: 'Experience',
  测试: 'Test',
